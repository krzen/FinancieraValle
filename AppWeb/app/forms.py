...
class AsientoContableForm(forms.ModelForm):
    ...
    ('CAE', '91 COSTOS POR DISTRIBUIR.'),
    ('CAE', '92 COSTOS DE PRODUCCIÓN'),
    ('CAE', '93 CENTROS DE COSTOS'),
    ('CAE', '94 GASTOS ADMINISTRATIVOS.'),
    ('CAE', '95 GASTOS DE VENTAS'),
    ('CAE', '96 GASTOS FINANCIEROS'),
    ('I', '70 VENTAS'),
    ...
    ('I', '79 CARGAS IMPUTABLES A CUENTAS DE COSTOS Y GASTOS'),]),  # Retirar choices por defecto
            'tipo_cuenta': forms.Select(choices=[
                ...
                ('C', 'Costo'),
                ('CC','Cuenta de Cierre'),
                ('CAE','Cuentas analíticas de explotación'),
                ('I', 'Ingresos')]),
